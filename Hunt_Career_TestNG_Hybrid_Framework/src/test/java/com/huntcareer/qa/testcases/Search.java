...
public class Search extends Base {
	...
	public void TCS_1_verifyValidSearch() {
	...
	public void TCS_2_verifyInvalidSearch() {
		sp = new SearchPage(driver);
	...
	public void TCS_3_verifySearchWithSpecialCharcters() {
		sp = new SearchPage(driver);
	...
	public void TCS_4_verifySearchWithFilters() {
		sp = new SearchPage(driver);
		sp.enterKeywordIntoSearchInputField(dataProp.getProperty("validSearchTerm"));
